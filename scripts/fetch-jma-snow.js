...
function stationElevationM(stationInfo) {
  if (stationInfo && typeof stationInfo.elev === "number" && Number.isFinite(stationInfo.elev)) {
    return stationInfo.elev;
  }
  return 0;
}
...
async function main() {
  ...
  for (const resort of resorts) {
    ...
    let best = { distKm: Infinity, elevDiffM: 0, selectionScore: Infinity, stationNo: null };
